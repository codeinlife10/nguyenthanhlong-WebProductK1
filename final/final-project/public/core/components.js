...
<ul class="tag-list card card-2">
    <li class="item header">
        ...
        <li class="item"><a href="https://techtalk.vn/lap-trinh-vien-hay-tu-cuu-lay-doi-mat-minh-truoc-khi-qua-muon.html" target="_blank" class="tag-link">#Cách để bảo vệ đôi mắt của dev</a></li>
        <li class="item"><a href="https://techtalk.vn/giu-suc-khoe-va-giu-tap-trung-khi-lam-viec.html"  target="_blank" class="tag-link">#Cách giữ sức khỏe và tập trung khi làm việc</a></li>
        <li class="item"><a href="https://techtalk.vn/polyphasic-sleep-giac-ngu-ngan-nhung-hieu-qua-cho-lap-trinh-vien.html"  target="_blank" class="tag-link">#Cách để có những giấc ngủ ngắn nhưng chất lượng</a></li>
        <li class="item"><a href="https://techtalk.vn/ky-su-36-tuoi-dot-tu-va-cau-chuyen-thuc-dem-canh-tinh-moi-nguoi.html"  target="_blank" class="tag-link">#Lời cảnh tỉnh khi làm việc không điều độ</a></li>
        <li class="item"><a href="https://techtalk.vn/su-that-dang-long-doi-khi-cam-dau-ngoi-code-la-cach-ngu-nhat-de-giai-quyet-van-de-2.html"  target="_blank" class="tag-link">#Hãy code 1 cách khoa học</a></li>
</ul>
</div>
`
...
<h2>Write a post</h2>
<form id="userData" class="form-user">
    ...
    <div class="form-group">
        ...
        <textarea rows="6" cols="45" type="text" placeholder="Enter content" name="content"></textarea>

    </div>
    <div class="modal-footer d-flex justify-content-center">
        <button class="btn btn-primary" id="return">Submit</button>
    </div>
</form>
</div>`